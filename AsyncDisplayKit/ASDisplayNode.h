 ...
 */
@property (nonatomic, assign, readwrite) CGSize preferredFrameSize ASDISPLAYNODE_DEPRECATED_MSG("This method is deprecated. Instead, use .style.preferredSize OR .style.preferredLayoutSize (for relative sizes) OR set individual values with .style.height, .style.minHeight, .style.maxHeight, .style.width, .style.minWidth, .style.maxWidth");
