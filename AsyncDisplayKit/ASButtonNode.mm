...
#endif
    stack.width = ASRelativeDimensionMake(ASRelativeDimensionTypePoints, self.preferredFrameSize.width);
    stack.height = ASRelativeDimensionMake(ASRelativeDimensionTypePoints, self.preferredFrameSize.height);
