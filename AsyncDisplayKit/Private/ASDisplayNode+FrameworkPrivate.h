...
typedef NS_OPTIONS(NSUInteger, ASHierarchyState)
{
  ...
  ASHierarchyStateYogaLayout              = 1 << 4,
  ASHierarchyStateVisualizeLayout         = 1 << 5
};
...
ASDISPLAYNODE_INLINE BOOL ASHierarchyStateIncludesYogaLayout(ASHierarchyState hierarchyState)
{
  return ((hierarchyState & ASHierarchyStateYogaLayout) == ASHierarchyStateYogaLayout);
}
