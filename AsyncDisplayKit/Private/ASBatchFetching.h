...
/**
 ...
 @param isScrollingTowardsTail If the current scroll direction is towards the tail-end
 ...
 @param trailingScreens How many screens in the current distance will trigger batch fetching.
