...
- (instancetype)_initWithFrame:(CGRect)frame style:(UITableViewStyle)style dataControllerClass:(Class)dataControllerClass ownedByNode:(BOOL)ownedByNode
{
  ...
  if ([ASRangeController shouldShowHierarchyDebugCountsOverlay]) {
    ...
    _debugHierarchyCountInfo.textNode = [[ASTextNode alloc] init];
    _debugHierarchyCountInfo.textNode.backgroundColor = [[UIColor greenColor] colorWithAlphaComponent:0.5];
