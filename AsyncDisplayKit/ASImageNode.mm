...
@property (strong) ASDisplayNodeContextModifier preContextBlock;
@property (strong) ASDisplayNodeContextModifier postContextBlock;
@property (strong) asimagenode_modification_block_t imageModificationBlock;
